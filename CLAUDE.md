...
Workspace instructions for Claude when working in this repository. Read this file before doing any task here.

These instructions align Claude with the product design already documented under `/docs`.
...
These instructions are successful if Claude produces focused diffs, avoids scope creep, and stays within the documented V1 architecture.
